...
class QuestionGeneratorAgent:
    ...
    def generate_questions_for_severity(
        ...
        raw = self.generate_question(age,gender,location,lifestyle,profession,severity,chosen_theme)
        return safe_parse_json(raw)

    def generate_question(self, age: str,gender: str,location: str,lifestyle: str,profession: str,severity: str,theme: str) -> str:
        """
...
Your goal is to generate 10  object anmes in english that help patients recognize and name items, supporting their ability to understand and speak.
